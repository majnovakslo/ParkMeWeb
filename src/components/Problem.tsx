  ...
  const problems = [
    {
      icon: Clock,
      title: 'Izgubljen Čas',
      description: 'Vozniki lahko porabijo 8-20 minut za iskanje parkirnega mesta v mestnih središčih (odvisno od lokacije in časa)',
      stat: '8-20 min',
      color: 'text-red-500',
      bgColor: 'bg-red-50',
    },
    {
      ...
      description: 'Lastniki parkirišč lahko izgubijo 15-40% potencialnih prihodkov zaradi neučinkovitega upravljanja',
      stat: '15-40%',
    ...
    },
    {
      icon: Users,
      title: 'Ročno Delo',
      description: 'Redarji porabijo večino delovnega časa (6-8h) za ročne obhode in preverjanje plačil',
      stat: '6-8h',
        ...
        <div ref={ref} className={`transition-all duration-1000 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-500 italic">
              * Ocene temeljijo na globalnih raziskavah parkirne industrije (MarketsandMarkets 2015-2025). 
              Dejanske vrednosti so odvisne od lokacije, infrastrukture in drugih dejavnikov.
            </p>
          </div>
